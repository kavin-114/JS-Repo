...
let nameDsp = document.getElementById('fullname_dsp'),
    ...
    websiteDsp = document.getElementById('website_dsp'),
...
const getUserInputs = () => {
    ...
    websiteElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.URL, 'Website'));
    linkedInElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.URL, 'LinkedIn'));
    githubElem.addEventListener('keyup', (e) => validateFormData(e.target, validType.URL, 'Github'));
...
function validateFormData(elem, elemType, elemName){
    ...
    // checking for URL
    if(elemType == validType.URL){
        if(!urlRegex.test(elem.value) || elem.value.trim().length == 0) addErrMsg(elem, elemName);
        else removeErrMsg(elem)
    }
...
const displayCV = (userData) => {
    ...
    websiteDsp.innerHTML = userData.website;
...
// Store the personalInfo object in local storage
